...
<section>
	<h2>Website</h2>
	<p>
		This website was build through pain and grind during session period as mean to make myself more
		familiar with web development in general. It has its own CMS and other neat stuff build from
		ground up.
	</p>
	<p>
