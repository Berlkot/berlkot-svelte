/*
This file was copied dirctly from https://github.com/highlightjs/highlightjs-gdscript/blob/master/src/languages/gdscript.js
I will maintain this file on my own to keep up with latest godot lang syntax.
...
Modifications: Berlkot <contact@berlkot.com>
...
function gdscript(hljs) {
	var KEYWORDS = {
		...
		built_in:
			...
			"print print_stack push_error push_warning rad2deg rand_range " +
